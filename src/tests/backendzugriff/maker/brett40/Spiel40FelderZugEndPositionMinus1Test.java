 ...
 * </pre>
 */
public class Spiel40FelderZugEndPositionMinus1Test {
	public static void main(String[] argv) {
		System.out.println("*".repeat(60));
		System.out.println("***** Test Anfang: 40 Spielfelder - Teste Zuege auf Endpositionen minus 1");
		System.out.println("*".repeat(60) + "\n");
		...
		System.out.println("\n" + "*".repeat(60));
		System.out.println("***** Test Ende: 40 Spielfelder - Teste Zuege auf Endpositionen minus 1");
		System.out.println("*".repeat(60));
	}
}
