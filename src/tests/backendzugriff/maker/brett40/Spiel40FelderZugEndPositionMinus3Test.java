 ...
 * </pre>
 */
public class Spiel40FelderZugEndPositionMinus3Test {
	public static void main(String[] argv) {
		System.out.println("*".repeat(60));
		System.out.println("***** Test Anfang: 40 Spielfelder - Teste Zuege auf Endpositionen minus 3");
		System.out.println("*".repeat(60) + "\n");
		...
		for(Spieler spieler : service.getAlleSpieler()) {
			erwartungen.put(
					...
					SpielFeld.erstelleFarblosesStreckenFeld(
							spieler.getEndStreckenFeld().getFeldPosition()-2
					)
			);
			erwartungen.put(
			...
			erwartungen.put(
					WuerfelErgebnis.DREI,
					SpielFeld.erstelleFarblosesStreckenFeld(
							spieler.getEndStreckenFeld().getFeldPosition()
					)
			);
			erwartungen.put(WuerfelErgebnis.VIER, SpielFeld.erstelleZielFeld(black, 0));
			erwartungen.put(WuerfelErgebnis.FUENF, SpielFeld.erstelleZielFeld(black, 1));
			erwartungen.put(WuerfelErgebnis.SECHS, SpielFeld.erstelleZielFeld(black, 2));
		...
		System.out.println("Alle Züge auf den Endpositionen minus 3 resultierten in die erwarteten Ziel-Feldern.");
		
		System.out.println("\n" + "*".repeat(60));
		System.out.println("***** Test Ende: 40 Spielfelder - Teste Zuege auf Endpositionen minus 3");
		System.out.println("*".repeat(60));
	}
}
