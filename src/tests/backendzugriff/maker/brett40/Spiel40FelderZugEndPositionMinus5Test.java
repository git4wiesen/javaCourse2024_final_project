 ...
 * </pre>
 */
public class Spiel40FelderZugEndPositionMinus5Test {
	public static void main(String[] argv) {
		System.out.println("*".repeat(60));
		System.out.println("***** Test Anfang: 48 Spielfelder - Teste Zuege auf Endpositionen minus 5");
		System.out.println("*".repeat(60) + "\n");
		...
		for(Spieler spieler : service.getAlleSpieler()) {
			erwartungen.put(
					...
					SpielFeld.erstelleFarblosesStreckenFeld(
							spieler.getEndStreckenFeld().getFeldPosition()-4
					)
			);
			erwartungen.put(
			...
			erwartungen.put(
					WuerfelErgebnis.FUENF,
					SpielFeld.erstelleFarblosesStreckenFeld(
							spieler.getEndStreckenFeld().getFeldPosition()
					)
			);
			erwartungen.put(WuerfelErgebnis.SECHS, SpielFeld.erstelleZielFeld(black, 0));
		...
		System.out.println("Alle Züge auf den Endpositionen minus 5 resultierten in die erwarteten Ziel-Feldern.");
		
		System.out.println("\n" + "*".repeat(60));
		System.out.println("***** Test Ende: 40 Spielfelder - Teste Zuege auf Endpositionen minus 5");
		System.out.println("*".repeat(60));
	}
}
