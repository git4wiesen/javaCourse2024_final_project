 ...
 */
package tests.backendzugriff.maker.brett40;
 ...
 * </pre>
 */
public class Spiel40FelderZugEndPositionTest {
	public static void main(String[] argv) {
		System.out.println("*".repeat(60));
		System.out.println("***** Test Anfang: 40 Spielfelder - Teste Zuege auf Endpositionen");
		System.out.println("*".repeat(60) + "\n");

		System.out.println("Erstelle ein Spiel mit 40 Streckenfeldern und 4 Teilnehmern");
		...
		erwartungen.put(WuerfelErgebnis.EINS, SpielFeld.erstelleZielFeld(black, 0));
		erwartungen.put(WuerfelErgebnis.ZWEI, SpielFeld.erstelleZielFeld(black, 1));
		erwartungen.put(WuerfelErgebnis.DREI, SpielFeld.erstelleZielFeld(black, 2));
		erwartungen.put(WuerfelErgebnis.VIER, SpielFeld.erstelleZielFeld(black, 3));
		erwartungen.put(WuerfelErgebnis.FUENF, null);
		...
		for(Map.Entry<WuerfelErgebnis, SpielFeld> entry : erwartungen.entrySet()) {
			...
			for(Spieler spieler : service.getAlleSpieler()) {
				...
				int figurPosition = spieler.getEndStreckenFeld().getFeldPosition();
		...
		System.out.println("Alle Züge auf den Endpositionen resultierten in die erwarteten Ziel-Feldern.");
		
		System.out.println("\n" + "*".repeat(60));
		System.out.println("***** Test Ende: 40 Spielfelder - Teste Zuege auf Endpositionen");
		System.out.println("*".repeat(60));
	}
}
