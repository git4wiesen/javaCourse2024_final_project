 ...
 * </pre>
 */
public class Spiel48FelderZugEndPositionMinus2Test {
	public static void main(String[] argv) {
		System.out.println("*".repeat(60));
		System.out.println("***** Test Anfang: 48 Spielfelder - Teste Zuege auf Endpositionen minus 2");
		System.out.println("*".repeat(60) + "\n");
		...
		System.out.println("\n" + "*".repeat(60));
		System.out.println("***** Test Ende: 48 Spielfelder - Teste Zuege auf Endpositionen minus 2");
		System.out.println("*".repeat(60));
	}
}
