 ...
 * </pre>
 */
public class Spiel48FelderZugEndPositionMinus4Test {
	public static void main(String[] argv) {
		System.out.println("*".repeat(60));
		System.out.println("***** Test Anfang: 48 Spielfelder - Teste Zuege auf Endpositionen minus 4");
		System.out.println("*".repeat(60) + "\n");
		...
		System.out.println("\n" + "*".repeat(60));
		System.out.println("***** Test Ende: 48 Spielfelder - Teste Zuege auf Endpositionen minus 4");
		System.out.println("*".repeat(60));
	}
}
