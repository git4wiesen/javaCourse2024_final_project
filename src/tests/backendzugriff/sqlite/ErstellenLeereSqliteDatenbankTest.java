 ...
 * </pre>
 */
public class ErstellenLeereSqliteDatenbankTest {
	...
	public static void main(String[] args) {
		System.out.println("\n" + "*".repeat(60) + "\n");
		System.out.println("***** Test Anfang: Erstelle SqLite Datenbank mit allen definierten Tabellen, die alle leer sein sollen");
		System.out.println("\n" + "*".repeat(60) + "\n");
		...
		try {
			...
			backendZugriff.erstellenAlleTabellen(false);
	
			System.out.println("\n" + "*".repeat(60) + "\n");
		} finally {
			System.out.println("\n" + "*".repeat(60) + "\n");
			System.out.println("***** Test Ende: Erstelle SqLite Datenbank mit allen definierten Tabellen, die alle leer sein sollen");
			System.out.println("\n" + "*".repeat(60) + "\n");
		}
	}
}
