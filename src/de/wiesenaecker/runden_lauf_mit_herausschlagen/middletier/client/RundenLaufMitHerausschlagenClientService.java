 ...
 * <pre>
 * 
 * Business logic of the game client.
 * @author Christian Alexander Wiesenäcker
 * 
 * </pre>
 */
public class RundenLaufMitHerausschlagenClientService implements RundenLaufMitHerausschlagenService {
	/**
	 * Backend-Zugriff
	 */
	private final RundenLaufMitHerausschlagenMitServerDao james;
	 ...
	 * </pre>
	 */
	public RundenLaufMitHerausschlagenClientService(RundenLaufMitHerausschlagenMitServerDao james) {
		this.james = james;
	}
}
